...
<div class="wrapper">
    <div class="container">
        ...
        if ((isset($_SESSION['ms']) && $_SESSION['ms']))
        {
            $compare = "0";
            $id = $_SESSION['ms'];
            $sql = " SELECT * FROM `don_hang` WHERE (don_hang.ten_dang_nhap = '$id' and don_hang.trang_thai_don_hang='done') ";
            $result = mysqli_query($ketnoi, $sql);
            $row = mysqli_fetch_array($result); ?>
            <h4> <br> <br> Chào bạn <?php echo $row[8];?> </h4>
            <h4> <br> <br> Đây là các đơn hàng bạn đã mua  </h4>
            <hr>
            ...
            { ?>
                ...
                if ($compare != $row[10]) {
                    ...
                    <form action='xem_don.php' method='GET'>
                        ...
                        <input type="hidden" name="id" value="<?php echo $madon=$row[10] ?>">
        ...
        {
            echo " <h3><br><br> Bạn chưa đăng nhập, nhập email để tra cứu đơn hàng đã mua <br></h3> <br><br><br><br><br> " ;
            ?>
