...
<body>
    ...
    <div class="wrapper">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-2 col-sm-2">
                        <div class="logo">
                            <a href="index.php">
                                <img src="images/logo.png" alt="Kimochi">
                            </a>
                        </div>
                    </div>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <ul class="option_nav">
                                        ...
                                        <li class="dorpdown">
                                            ...
                                            <ul class="subnav">
                                                <li>
                                                    <a href="https://www.facebook.com/linhku59">
                                                        Facebook
                                                    </a>
                                                </li>
                                                <li>
        ...
        <?php  if ( !(isset($_SESSION['ms'])) and !(isset($_SESSION['km'])) )
    {  ?>
        <div class="image">
            <img data-v-60e8697e="" src="images/km/adidas2.JPG" class="center-block" alt="our purpose"
    ...
    ?>
        ...
        <body style="background: #333333;">
            ...
            ?>
                        ...
                        <div class="hot-products">
                            ...
                            while ($all[0] != "" and $i<8) { ?>
                                        <div class="col-md-3 col-sm-6 ">
                                            <div class="products">
                                                <div class="thumbnail">
                                                    <a href="xem_chi_tiet.php?id=<?php echo $all[0] ?>"><img
                                                            src="images/products/min/<?php echo $all[0] ?>-1.jpg"
                                                            alt="Hinh anh"></a>
                                                </div>
                        ...
                        <div class="hot-products">
                            <h3 class="title"><strong>Còn nữa</strong></h3>
                            <ul id="hot">
                                <li>
                                    <div class="row">
                                        <?php $i=0;
                        ...
                        <div class="our-brand">
                            <h3 class="title" style="color: #f7544a"><strong>Kimochi store</strong> đồng hành cùng</h3>
